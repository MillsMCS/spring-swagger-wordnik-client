/*
 * api.wordnik.com No description provided (generated by Swagger Codegen
...
public class AudioFile {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(attributionText, attributionUrl, audioType, commentCount, createdAt,
                createdBy, description, duration, fileUrl, id, voteAverage, voteCount,
                voteWeightedAverage, word);
    }
    ...
    public String toString() {
        ...
        sb.append("    voteWeightedAverage: ").append(toIndentedString(voteWeightedAverage))
                .append("\n");
