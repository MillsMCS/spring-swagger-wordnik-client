...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen",
        date = "2020-11-09T16:51:03.324-08:00")
public interface WordsApi extends ApiClient.Api {
     ...
     * 
     * @param hasDictionaryDef Only return words with dictionary definitions (optional, default to
     *        true)
     * @param includePartOfSpeech CSV part-of-speech values to include (allowable values are noun,
     *        adjective, verb, adverb, interjection, pronoun, preposition, abbreviation, affix,
     *        article, auxiliary-verb, conjunction, definite-article, family-name, given-name,
     *        idiom, imperative, noun-plural, noun-posessive, past-participle, phrasal-prefix,
     *        proper-noun, proper-noun-plural, proper-noun-posessive, suffix, verb-intransitive,
     *        verb-transitive) (optional)
     * @param excludePartOfSpeech CSV part-of-speech values to exclude (allowable values are noun,
     *        adjective, verb, adverb, interjection, pronoun, preposition, abbreviation, affix,
     *        article, auxiliary-verb, conjunction, definite-article, family-name, given-name,
     *        idiom, imperative, noun-plural, noun-posessive, past-participle, phrasal-prefix,
     *        proper-noun, proper-noun-plural, proper-noun-posessive, suffix, verb-intransitive,
    ...
    WordObject getRandomWord(@Param("hasDictionaryDef") String hasDictionaryDef,
            @Param("includePartOfSpeech") String includePartOfSpeech,
            @Param("excludePartOfSpeech") String excludePartOfSpeech,
            @Param("minCorpusCount") Integer minCorpusCount,
            @Param("maxCorpusCount") Integer maxCorpusCount,
            @Param("minDictionaryCount") Integer minDictionaryCount,
            @Param("maxDictionaryCount") Integer maxDictionaryCount,
            @Param("minLength") Integer minLength, @Param("maxLength") Integer maxLength);

    /**
     * Returns a single random WordObject
     * 
     * Note, this is equivalent to the other <code>getRandomWord</code> method, but with the query
     * parameters collected into a single Map parameter. This is convenient for services with
     * optional query parameters, especially when used with the {@link GetRandomWordQueryParams}
     ...
     *        </p>
     *        <ul>
     *        <li>hasDictionaryDef - Only return words with dictionary definitions (optional,
     *        default to true)</li>
     *        <li>includePartOfSpeech - CSV part-of-speech values to include (allowable values are
     ...
     *        verb-intransitive, verb-transitive) (optional)</li>
     *        <li>excludePartOfSpeech - CSV part-of-speech values to exclude (allowable values are
     *        noun, adjective, verb, adverb, interjection, pronoun, preposition, abbreviation,
     *        affix, article, auxiliary-verb, conjunction, definite-article, family-name,
     *        given-name, idiom, imperative, noun-plural, noun-posessive, past-participle,
     *        phrasal-prefix, proper-noun, proper-noun-plural, proper-noun-posessive, suffix,
    ...
    /**
     * A convenience class for generating query parameters for the <code>getRandomWord</code> method
     * in a fluent style.
     */
    ...
    List<WordObject> getRandomWords(@Param("hasDictionaryDef") String hasDictionaryDef,
            @Param("includePartOfSpeech") String includePartOfSpeech,
            @Param("excludePartOfSpeech") String excludePartOfSpeech,
            @Param("minCorpusCount") Integer minCorpusCount,
            @Param("maxCorpusCount") Integer maxCorpusCount,
     ...
     * Returns an array of random WordObjects
     * 
     * Note, this is equivalent to the other <code>getRandomWords</code> method, but with the query
     * parameters collected into a single Map parameter. This is convenient for services with
     * optional query parameters, especially when used with the {@link GetRandomWordsQueryParams}
     * class that allows for building up this map in a fluent style.
     *
     * @param queryParams Map of query parameters as name-value pairs
     *        <p>
    ...
    /**
     * A convenience class for generating query parameters for the <code>getRandomWords</code>
     ...
     * Returns a specific WordOfTheDay
     * 
     * Note, this is equivalent to the other <code>getWordOfTheDay</code> method, but with the query
     * parameters collected into a single Map parameter. This is convenient for services with
     * optional query parameters, especially when used with the {@link GetWordOfTheDayQueryParams}
     * class that allows for building up this map in a fluent style.
     *
     * @param queryParams Map of query parameters as name-value pairs
     *        <p>
    ...
    /**
     * A convenience class for generating query parameters for the <code>getWordOfTheDay</code>
     * method in a fluent style.
     */
     ...
     * @param includePartOfSpeech Only include these comma-delimited parts of speech (allowable
     ...
     *        proper-noun-posessive, suffix, verb-intransitive, verb-transitive) (optional)
     * @param excludePartOfSpeech Exclude these comma-delimited parts of speech (allowable values
     *        are noun, adjective, verb, adverb, interjection, pronoun, preposition, abbreviation,
     *        affix, article, auxiliary-verb, conjunction, definite-article, family-name,
     *        given-name, idiom, imperative, noun-plural, noun-posessive, past-participle,
     *        phrasal-prefix, proper-noun, proper-noun-plural, proper-noun-posessive, suffix,
     *        verb-intransitive, verb-transitive) (optional)
    ...
    DefinitionSearchResults reverseDictionary(@Param("query") String query,
            @Param("findSenseForWord") String findSenseForWord,
            @Param("includeSourceDictionaries") String includeSourceDictionaries,
            @Param("excludeSourceDictionaries") String excludeSourceDictionaries,
            @Param("includePartOfSpeech") String includePartOfSpeech,
            @Param("excludePartOfSpeech") String excludePartOfSpeech,
            @Param("minCorpusCount") Integer minCorpusCount,
            @Param("maxCorpusCount") Integer maxCorpusCount, @Param("minLength") Integer minLength,
            @Param("maxLength") Integer maxLength, @Param("expandTerms") String expandTerms,
            @Param("includeTags") String includeTags, @Param("sortBy") String sortBy,
            @Param("sortOrder") String sortOrder, @Param("skip") String skip,
            @Param("limit") Integer limit);

    /**
     * Reverse dictionary search
     * 
     * Note, this is equivalent to the other <code>reverseDictionary</code> method, but with the
     * query parameters collected into a single Map parameter. This is convenient for services with
     * optional query parameters, especially when used with the {@link ReverseDictionaryQueryParams}
     * class that allows for building up this map in a fluent style.
     *
     * @param queryParams Map of query parameters as name-value pairs
     *        <p>
     ...
     *        <li>includeSourceDictionaries - Only include these comma-delimited source dictionaries
     *        (optional)</li>
     *        <li>excludeSourceDictionaries - Exclude these comma-delimited source dictionaries
     *        (optional)</li>
     *        <li>includePartOfSpeech - Only include these comma-delimited parts of speech
     *        (allowable values are noun, adjective, verb, adverb, interjection, pronoun,
     *        preposition, abbreviation, affix, article, auxiliary-verb, conjunction,
     *        definite-article, family-name, given-name, idiom, imperative, noun-plural,
     *        noun-posessive, past-participle, phrasal-prefix, proper-noun, proper-noun-plural,
     *        proper-noun-posessive, suffix, verb-intransitive, verb-transitive) (optional)</li>
     *        <li>excludePartOfSpeech - Exclude these comma-delimited parts of speech (allowable
     *        values are noun, adjective, verb, adverb, interjection, pronoun, preposition,
     *        abbreviation, affix, article, auxiliary-verb, conjunction, definite-article,
     *        family-name, given-name, idiom, imperative, noun-plural, noun-posessive,
     *        past-participle, phrasal-prefix, proper-noun, proper-noun-plural,
     ...
     *        <li>includeTags - Return a closed set of XML tags in response (optional, default to
     *        false)</li>
     *        <li>sortBy - Attribute to sort by (optional)</li>
     *        <li>sortOrder - Sort direction (optional)</li>
    ...
    DefinitionSearchResults reverseDictionary(
            @QueryMap(encoded = true) Map<String, Object> queryParams);

    /**
     * A convenience class for generating query parameters for the <code>reverseDictionary</code>
     * method in a fluent style.
     */
     ...
     * @param minCorpusCount Minimum corpus frequency for terms (optional, default to 5)
     * @param maxCorpusCount Maximum corpus frequency for terms (optional, default to -1)
     * @param minDictionaryCount Minimum number of dictionary entries for words returned (optional,
     *        default to 1)
    ...
    WordSearchResults searchWords(@Param("query") String query,
            @Param("allowRegex") String allowRegex, @Param("caseSensitive") String caseSensitive,
            @Param("includePartOfSpeech") String includePartOfSpeech,
            @Param("excludePartOfSpeech") String excludePartOfSpeech,
            @Param("minCorpusCount") Integer minCorpusCount,
            @Param("maxCorpusCount") Integer maxCorpusCount,
     ...
     * Searches words
     * 
     * Note, this is equivalent to the other <code>searchWords</code> method, but with the query
     * parameters collected into a single Map parameter. This is convenient for services with
     * optional query parameters, especially when used with the {@link SearchWordsQueryParams} class
     ...
     *        <li>minCorpusCount - Minimum corpus frequency for terms (optional, default to 5)</li>
     *        <li>maxCorpusCount - Maximum corpus frequency for terms (optional, default to -1)</li>
     *        <li>minDictionaryCount - Minimum number of dictionary entries for words returned
     *        (optional, default to 1)</li>
     *        <li>maxDictionaryCount - Maximum dictionary definition count (optional, default to
     *        -1)</li>
     *        <li>minLength - Minimum word length (optional, default to 1)</li>
     *        <li>maxLength - Maximum word length (optional, default to -1)</li>
     *        <li>skip - Results to skip (optional, default to 0)</li>
    ...
    /**
     * A convenience class for generating query parameters for the <code>searchWords</code> method
     * in a fluent style.
     */
