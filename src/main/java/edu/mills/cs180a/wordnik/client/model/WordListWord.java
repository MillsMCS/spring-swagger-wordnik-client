...
public class WordListWord {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createdAt, id, numberCommentsOnWord, numberLists, userId, username,
                word);
    }
    ...
    public String toString() {
        ...
        sb.append("    numberCommentsOnWord: ").append(toIndentedString(numberCommentsOnWord))
                .append("\n");
