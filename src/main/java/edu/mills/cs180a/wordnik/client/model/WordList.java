...
public class WordList {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createdAt, description, id, lastActivityAt, name, numberWordsInList,
                permalink, type, updatedAt, userId, username);
    }
    ...
    public String toString() {
        ...
        sb.append("    numberWordsInList: ").append(toIndentedString(numberWordsInList))
                .append("\n");
